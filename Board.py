...
class Board:
    ...
    def _newGrid(numRows,numCols):
        ...
        """
        grid = [None]*numRows#empty list
        for i in range(0,numRows):
            grid.append([None]*numCols)
        return grid
    ...
    def _isValidMove(self, direction):
        ...
        Returns: True iff the die movement on the board is legal
        """
    ...
    def _isGoal(self):
        ...
        Returns: True iff the die is in goal state:
    ...
    def isGoal(self,location,die):
        ...
        Returns: True iff the location and die would result in a goal state.
        """
